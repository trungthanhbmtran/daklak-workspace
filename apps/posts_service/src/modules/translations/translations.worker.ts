...
export class TranslationsWorker {
    ...
    async handleTranslationResults(@Payload() data: any) {
        try {
            console.log('📥 [Translation Worker] Processing translation result:', data);
            ...
            console.log(`✅ [Translation Worker] Saved translation for Post ${payload.postId} (${payload.lang})`);
        } catch (error) {
