...
async function main() {
  ...
  const taskWorkflowDef = {
    ...
    edges: [
      ...
      { id: 'edge_gw_end',           source: 'gw_approve',            target: 'node_end',             label: 'APPROVE', data: { expression: 'action === "APPROVE"' } },
      { id: 'edge_gw_return',        source: 'gw_approve',            target: 'node_in_progress',     label: 'REJECT',  data: { expression: 'action === "REJECT"' } },
    ],
  };
  ...
  const docTransferWorkflowDef = {
    ...
    edges: [
      ...
      { id: 'edge_gw_assign',      source: 'gw_route',          target: 'node_assign_staff',  label: 'ASSIGN_DEPT', data: { expression: 'action === "ASSIGN_DEPT"' } },
      { id: 'edge_gw_archive',     source: 'gw_route',          target: 'node_issue',         label: 'ARCHIVE',     data: { expression: 'action === "ARCHIVE"' } },
      ...
      { id: 'edge_approve_gw',     source: 'node_approve',      target: 'gw_approve',         label: 'APPROVE' },
      { id: 'edge_gw_issue',       source: 'gw_approve',        target: 'node_issue',         label: 'APPROVE', data: { expression: 'action === "APPROVE"' } },
      { id: 'edge_gw_return',      source: 'gw_approve',        target: 'node_process',       label: 'REJECT',  data: { expression: 'action === "REJECT"' } },
  ...
  const articleWorkflowDef = {
    ...
    edges: [
      ...
      { id: 'edge_gw_approve',      source: 'gw_edit',      target: 'node_approve', label: 'APPROVE', data: { expression: 'action === "APPROVE"' } },
      { id: 'edge_gw_return_draft', source: 'gw_edit',      target: 'node_draft',   label: 'REJECT',  data: { expression: 'action === "REJECT"' } },
      { id: 'edge_approve_gw',      source: 'node_approve', target: 'gw_approve',   label: 'APPROVE' },
      { id: 'edge_gw_publish',      source: 'gw_approve',   target: 'node_publish', label: 'APPROVE', data: { expression: 'action === "APPROVE"' } },
      { id: 'edge_gw_return_edit',  source: 'gw_approve',   target: 'node_edit',    label: 'REJECT',  data: { expression: 'action === "REJECT"' } },
