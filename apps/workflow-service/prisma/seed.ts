...
const leaveRequestGraph = {
  nodes: [
    ...
    { id: 'task_1', type: 'user_task', position: { x: 250, y: 150 }, data: { label: 'Nhân viên nộp đơn', assigneeRole: 'EMPLOYEE', formSchema: JSON.stringify([{id:"f1",name:"reason",label:"Lý do",type:"textarea"},{id:"f2",name:"startDate",label:"Ngày bắt đầu",type:"date"},{id:"f3",name:"endDate",label:"Ngày kết thúc",type:"date"},{id:"f4",name:"leaveDays",label:"Số ngày nghỉ",type:"number"}]) } },
...
const govComplexTaskGraph = {
  nodes: [
    { id: 'start_1', type: 'start', position: { x: 250, y: 50 }, data: { label: 'Bắt đầu' } },
    { id: 'task_assign', type: 'user_task', position: { x: 250, y: 150 }, data: { label: 'Giao việc (Lãnh đạo)', assigneeRole: 'MANAGER', formSchema: JSON.stringify([{id:"f1",name:"taskName",label:"Tên công việc",type:"text"},{id:"f2",name:"description",label:"Mô tả",type:"textarea"},{id:"f3",name:"dueDate",label:"Hạn chót",type:"date"},{id:"f4",name:"assigneeId",label:"Người nhận",type:"text"}]) } },
    { id: 'gateway_accept', type: 'exclusive_gateway', position: { x: 250, y: 250 }, data: { label: 'Tiếp nhận hay Từ chối?' } },
    { id: 'task_process', type: 'user_task', position: { x: 250, y: 350 }, data: { label: 'Xử lý & Phối hợp (Chuyên viên)', assigneeRole: 'STAFF', formSchema: JSON.stringify([{id:"f1",name:"reportContent",label:"Nội dung báo cáo",type:"textarea"},{id:"f2",name:"attachments",label:"Đính kèm",type:"text"},{id:"f3",name:"coordinators",label:"Người phối hợp",type:"text"}]), multiInstanceLoopCharacteristics: { isSequential: false, collectionString: 'variables.assignees' } } },
    { id: 'task_evaluate', type: 'user_task', position: { x: 250, y: 450 }, data: { label: 'Nghiệm thu & Chấm KPI', assigneeRole: 'MANAGER', formSchema: JSON.stringify([{id:"f1",name:"isApproved",label:"Đồng ý duyệt",type:"text"},{id:"f2",name:"kpiScore",label:"Điểm KPI",type:"number"},{id:"f3",name:"managerFeedback",label:"Phản hồi",type:"textarea"}]) } },
