...
CREATE TABLE `auth_accounts` (
    ...
    INDEX `auth_accounts_user_id_fkey`(`user_id`),
...
-- CreateTable
CREATE TABLE `sys_category_translations` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    ...
    INDEX `sys_category_translations_lang_code_idx`(`lang_code`),
    UNIQUE INDEX `sys_category_translations_category_id_lang_code_key`(`category_id`, `lang_code`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `sys_menus` (
    ...
    INDEX `sys_menus_parent_id_order_idx`(`parent_id`, `order`),
    INDEX `sys_menus_parent_id_fkey`(`parent_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `organization_unit_domains` (
    ...
    INDEX `organization_unit_domains_domain_id_fkey`(`domain_id`),
...
CREATE TABLE `org_staffing` (
    ...
    INDEX `org_staffing_job_title_id_fkey`(`job_title_id`),
...
CREATE TABLE `policies` (
    ...
    INDEX `policies_resource_id_fkey`(`resource_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `unit_type_job_templates` (
    ...
    INDEX `unit_type_job_templates_job_title_id_fkey`(`job_title_id`),
...
CREATE TABLE `job_positions` (
    ...
    INDEX `job_positions_job_title_id_fkey`(`job_title_id`),
    INDEX `job_positions_unit_id_fkey`(`unit_id`),
    INDEX `job_positions_user_id_fkey`(`user_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `_PolicyToRole` ADD CONSTRAINT `_PolicyToRole_A_fkey` FOREIGN KEY (`A`) REFERENCES `policies`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `_PolicyToRole` ADD CONSTRAINT `_PolicyToRole_B_fkey` FOREIGN KEY (`B`) REFERENCES `roles`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
