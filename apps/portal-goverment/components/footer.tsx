          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-white uppercase tracking-wider">
                {getConfigValue("footer_portal_title", "CỔNG DỊCH VỤ CÔNG TRỰC TUYẾN XÃ DANG KANG")}
              </p>
              <p className="text-xs text-slate-400">
                {getConfigValue("footer_portal_subtitle", "Tiếp nhận giải quyết thủ tục hành chính một cửa hiện đại, nhanh chóng")}
              </p>
            </div>
          </div>
          <Link
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 relative z-10">
        ...
        <div className="lg:col-span-4 flex flex-col gap-4">
          ...
          <p className="text-xs text-slate-400 leading-relaxed">
            {getConfigValue("license_info", "Giấy phép số: 45/GP-TTĐT do Sở Thông tin và Truyền thông tỉnh Đắk Lắk cấp")}. Chịu trách nhiệm nội dung: {getConfigValue("responsible_person", "Ông Trần Văn Minh - Chủ tịch UBND xã Dang Kang")}.
          </p>
          ...
          <div className="flex items-center gap-3 bg-red-950/15 border border-red-900/20 p-3 rounded-lg">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[9px] text-slate-400 leading-normal">
                Được kiểm duyệt an ninh mạng bởi Cục An toàn thông tin.
              </span>
            </div>
          </div>
        </div>
