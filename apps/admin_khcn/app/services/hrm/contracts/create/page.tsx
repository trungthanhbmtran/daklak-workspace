      ...
      <div className="max-w-[1200px] mx-auto space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-black tracking-tight text-slate-900">Thêm hợp đồng</h2>
              <p className="text-sm text-slate-500 font-medium italic">Tạo hợp đồng lao động mới cho nhân viên</p>
            </div>
          </div>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 min-h-[400px] flex items-center justify-center text-slate-500">
          Form tạo hợp đồng sẽ được thiết kế tại đây.
        </div>
      </div>
    </div>
  );
