      ...
      <div className="max-w-[1200px] mx-auto space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-black tracking-tight text-slate-900">Tạo đơn nghỉ phép</h2>
              <p className="text-sm text-slate-500 font-medium italic">Gửi yêu cầu nghỉ phép mới</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <Button className="rounded-xl bg-blue-700 hover:bg-blue-800 px-8 h-11 font-bold shadow-lg shadow-blue-200">
              <Save className="mr-2 h-4 w-4" /> GỬI YÊU CẦU
            </Button>
          </div>
        </div>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 min-h-[400px] flex items-center justify-center text-slate-500">
          Form tạo đơn nghỉ phép sẽ được thiết kế tại đây.
        </div>
      </div>
    </div>
  );
