...
const categoryGroups = [
  { id: 'TYPE', name: 'Loại văn bản', icon: BookOpen, count: 12 },
  { id: 'FIELD', name: 'Lĩnh vực', icon: FolderTree, count: 18 },
  { id: 'AUTHORITY', name: 'Cơ quan ban hành', icon: Building2, count: 24 },
];
                ...
                {categoryGroups.map((group) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Badge className={isActive ? 'bg-primary-foreground/20 text-primary-foreground' : 'bg-muted-foreground/10 text-muted-foreground'}>
                        {group.count}
                      </Badge>
                    </button>
                  );
              ...
              <CardHeader className="bg-background border-b py-4">
                 <div className="flex justify-between items-center">
                    <div className="relative w-72">
                       ...
                       <Input placeholder="Tìm kiếm danh mục..." className="pl-10 h-10 bg-muted/20 border-none rounded-xl" />
                    </div>
              ...
              <CardContent className="p-0">
                 <table className="w-full text-sm text-left">
                    ...
                    <tbody className="divide-y divide-border/50">
                       {(mockCategories[activeGroup as keyof typeof mockCategories] || []).map((cat) => (
