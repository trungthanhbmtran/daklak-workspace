      ...
      <Card className="border-none shadow-xl shadow-foreground/5 bg-background/60 backdrop-blur-sm rounded-2xl overflow-hidden">
        <div className="p-5 border-b bg-background flex flex-wrap gap-3 items-center">
          <div className="relative flex-1 min-w-[300px]">
            ...
            <Input placeholder="Tìm theo tiêu đề, địa điểm, thành phần tham dự..." className="pl-10 h-11 bg-muted/20 border-none rounded-xl focus-visible:ring-primary/20" />
          </div>
        ...
        <CardContent className="p-0 overflow-x-auto">
          <table className="w-full text-sm text-left border-collapse">
            ...
            <tbody className="divide-y divide-border/50">
              <tr className="hover:bg-primary/[0.02] transition-all group cursor-pointer">
                <td className="px-6 py-6">
                  <div className="flex flex-col gap-1">
                    <span className="font-bold text-foreground">26/02/2026</span>
                    <span className="text-[10px] text-muted-foreground flex items-center gap-1 uppercase">
                      <Clock className="h-3 w-3" /> 08:30 AM
                    </span>
                    <span className="text-[10px] text-primary/70 flex items-center gap-1 mt-1 font-medium italic">
                      <MapPin className="h-3 w-3" /> Phòng họp số 1
                    </span>
                  </div>
                </td>
                <td className="px-6 py-6">
                  <p className="font-bold text-foreground group-hover:text-primary transition-colors text-base leading-snug">Họp Hội đồng Khoa học xét duyệt thuyết minh đề tài cấp tỉnh năm 2026</p>
                  <div className="flex items-center gap-2 mt-2">
                    <Badge variant="outline" className="bg-emerald-50 text-emerald-700 border-emerald-200 text-[10px] shadow-none">Đã ký phát hành</Badge>
                  </div>
                </td>
                <td className="px-6 py-6">
                  <div className="flex flex-col gap-1.5">
                    <div className="flex items-center gap-2 text-xs font-medium text-foreground">
                      <Users className="h-3.5 w-3.5 text-muted-foreground" /> 08 thành viên
                    </div>
                    <div className="flex -space-x-2">
                      <div className="w-7 h-7 rounded-full bg-primary/20 border-2 border-background flex items-center justify-center text-[10px] font-bold text-primary">NV</div>
                      <div className="w-7 h-7 rounded-full bg-amber-100 border-2 border-background flex items-center justify-center text-[10px] font-bold text-amber-700">TM</div>
                      <div className="w-7 h-7 rounded-full bg-blue-100 border-2 border-background flex items-center justify-center text-[10px] font-bold text-blue-700">LD</div>
                      <div className="w-7 h-7 rounded-full bg-muted border-2 border-background flex items-center justify-center text-[10px] font-bold text-muted-foreground">+5</div>
                    </div>
                  </div>
                </td>
          ...
          <div className="p-8 text-center bg-muted/5 border-t">
            <p className="text-xs text-muted-foreground font-medium uppercase tracking-widest">Hiển thị 1 trong 1 biên bản</p>
          </div>
        </CardContent>
      </Card>
    </div>
