      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="space-y-1.5">
          ...
          <h2 className="text-3xl font-black tracking-tight text-foreground flex items-center gap-3">
            Quản lý Luồng Lấy Ý Kiến
          </h2>
          <p className="text-muted-foreground font-medium max-w-2xl">
            Hệ thống giám sát và đôn đốc tiến độ góp ý các văn bản dự thảo do đơn vị chủ trì.
          </p>
        </div>
          ...
          <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
            ...
            {(searchTerm || statusFilter !== "ALL") && (
              <Button
                ...
                className="h-12 rounded-2xl px-4 font-bold text-muted-foreground hover:text-primary hover:bg-primary/10 transition-all"
              >
          ...
          {isLoading ? (
            <div className="p-32 flex flex-col items-center justify-center space-y-4">
              <div className="relative">
                ...
                <MessageSquareShare className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-6 w-6 text-primary" />
              </div>
            ...
            <div className="p-32 text-center flex flex-col items-center justify-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground font-medium max-w-sm mx-auto">
                  Không tìm thấy đợt lấy ý kiến nào phù hợp với bộ lọc hiện tại. Vui lòng thử lại với từ khóa khác.
                </p>
              </div>
                    ...
                    <tr key={item.id} className="hover:bg-muted/10 transition-all group">
                      ...
                      <td className="px-6 py-6">
                        <div className="flex flex-col gap-2">
                          ...
                          {isUrgent && (
                            <div className="flex items-center gap-1 text-[10px] font-black text-rose-600 animate-pulse uppercase tracking-tight">
