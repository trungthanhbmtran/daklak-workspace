...
const ProgressByUnitChart = dynamic(() => import("./HrmCharts").then(m => m.ProgressByUnitChart), {
  ssr: false,
  loading: () => <div className="h-full flex items-center justify-center text-slate-400"><Loader2 className="animate-spin h-6 w-6" /></div>
});

const StatsByLeaderChart = dynamic(() => import("./HrmCharts").then(m => m.StatsByLeaderChart), {
  ssr: false,
  loading: () => <div className="h-full flex items-center justify-center text-slate-400"><Loader2 className="animate-spin h-6 w-6" /></div>
});
        ...
        return (
          <div className="h-[300px] w-full pt-4">
            {isLoading ? (
              ...
              <ProgressByUnitChart isLoading={isLoading} data={progressByUnitData} />
            )}
          </div>
        );
        ...
        return (
          <div className="h-[300px] w-full flex items-center justify-center pt-4">
            {isLoading ? (
              ...
              <StatsByLeaderChart isLoading={isLoading} data={statsByLeaderData} />
            )}
          </div>
        );
      default:
