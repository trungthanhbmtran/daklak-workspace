            ...
            {isCurrentView && (
              <div className="flex flex-col z-10 relative h-full">
                <div className="flex items-center justify-between shrink-0">
                  <Text as="span" variant="small" weight="medium" className={`w-7 h-7 flex items-center justify-center rounded-full transition-all ${isTodayFlag ? "bg-primary text-primary-foreground shadow-sm" :
