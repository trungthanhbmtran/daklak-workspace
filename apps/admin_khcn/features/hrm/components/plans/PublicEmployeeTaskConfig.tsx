...
export function PublicEmployeeTaskConfig({ templates, units, ranks }: { templates: any[], units: CategoryItem[], ranks: CategoryItem[] }) {
    ...
    const [selectedRank, setSelectedRank] = useState<string>('VIEN_CHUC_HANG_3');
        ...
        <div className="space-y-4">
            <div className="space-y-4 bg-slate-50/50 p-4 rounded-xl border border-slate-200">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                    <div className="md:col-span-3 space-y-1">
                        <label className="text-[10px] font-black text-slate-500 uppercase">Chức danh nghề nghiệp</label>
                    ...
                    <div className="md:col-span-6 space-y-1">
                        ...
                        <Input
                            placeholder="Nhập nội dung tác vụ chuyên môn..."
                            value={newTaskName}
            ...
            <div className="border rounded-xl overflow-hidden bg-white">
                <div className="bg-slate-900 text-white px-4 py-3 text-xs font-black uppercase tracking-wider flex items-center gap-2">
                    ...
                    Thư viện phân cấp nhiệm vụ chuyên môn hiện hành
                </div>
