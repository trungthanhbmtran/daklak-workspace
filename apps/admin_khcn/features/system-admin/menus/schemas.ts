...
export const menuFormSchema = z.object({
  ...
  /** Với node gốc: bắt buộc. Node con: auto-inherit từ cha (có thể rỗng ở form, backend xử lý) */
  service: z.string().optional().default(""),
  /** Luôn là ADMIN_PORTAL trong admin portal — auto-fill, không cần user chọn */
