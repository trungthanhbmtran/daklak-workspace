...
export function AdvancedCssEditor() {
    ...
    return (
        <div className="space-y-3">
            <div className="relative rounded-lg overflow-hidden border border-border bg-slate-950 text-slate-200 font-mono text-xs">
                {/* Thanh header nhỏ của editor mô phỏng IDE */}
                <div className="bg-slate-900 px-4 py-2 border-b border-slate-800/80 flex justify-between items-center text-[11px] text-muted-foreground">
