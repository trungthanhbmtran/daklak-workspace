...
export function TypographyConfig() {
    return (
        <div className="space-y-4">
            {/* Font Tiêu Đề */}
            <div>
                <label className="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1.5">Font chữ Tiêu đề (Headings)</label>
            ...
            {/* Font Nội Dung */}
            <div>
                <label className="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1.5">Font chữ Nội dung (Body Text)</label>
                <select className="w-full text-sm bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                <div className="flex justify-between text-xs font-medium text-slate-500 dark:text-slate-400 mb-1.5">
                    ...
                    <span className="font-bold text-blue-500">14px</span>
                </div>
                <input
                    type="range"
                    min="12"
