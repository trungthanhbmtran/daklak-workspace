  ...
  return (
    <Card className="border border-border shadow-sm rounded-xl overflow-hidden transition-all duration-300 hover:shadow-md bg-card">
      ...
      <CardContent className="p-5 space-y-4">
        ...
        <div className="group relative border border-border rounded-xl p-4 bg-muted/30 hover:border-primary/50 hover:shadow-sm transition-all duration-300">
          <div className="flex gap-3">
            ...
            <div className="space-y-1">
              <h4 className="text-[11px] font-black text-foreground uppercase tracking-wide">
              ...
              <Button
                ...
                className="p-0 text-primary hover:text-primary/80 font-extrabold text-[10px] h-auto mt-1 flex items-center gap-1"
              >
